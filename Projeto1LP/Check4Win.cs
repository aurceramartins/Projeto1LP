                ...
                for (int j = 6; j >= 0; j--)
                {
                    if (symbols[i, j] != '|')
                    {
                        if (j >= 3)
                        {
                            ...
                            {
                                Console.WriteLine("Gañeeeeeeeeeeeeeeiiiiiiiiiiiiii");
                            }
                            //  }
                        }
                        else if (i >= 3)
                        ...
                        if (i >= 3 && j >= 3)
                        {
                            ...
                            {
                                Console.WriteLine("Diagonaaaaaaaaaaaaaaaaaaaaaaaaaaaalmais");
                            }
                        }
                        if (i >= 3 && j <= 3)
                        {
                            if (symbols[i, j] == symbols[i - 1, j + 1] && symbols[i, j] == symbols[i - 2, j + 2] && symbols[i, j] == symbols[i - 3, j + 3])
                            {
                                Console.WriteLine("Diagonaaaaaaaaaaaaaaaaaaaaaaaaaaaaaalmenos");
                            }
                        }
                    }
                }
